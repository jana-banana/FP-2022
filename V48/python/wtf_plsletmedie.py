...
if os.path.exists("../build_j") == False:
   os.mkdir("../build_j")
...
plt.savefig('../build_j/untergrund_1.pdf')
plt.clf()
...
plt.savefig('../build_j/untergrund_2.pdf')
plt.clf()
...
plt.savefig('../build_j/zeit_temp.pdf')
plt.clf()
...
plt.savefig('../build_j/zeit_temp_fit_1.pdf')
plt.clf()
...
plt.savefig('../build_j/zeit_temp_fit_2.pdf')
plt.clf()
...
plt.grid()
plt.legend()
plt.savefig('../build_j/korrigierte_werte_1.pdf')
plt.clf()
...
plt.legend()
plt.savefig('../build_j/log(I)_1durchT_1.pdf')
plt.clf()
...
plt.grid()
plt.legend()
plt.savefig('../build_j/korrigierte_werte_2.pdf')
plt.clf()

# plt.plot(log_T_2, log_I_2, '+k')
plt.plot(1/T_2_korr, np.log(I_2_korr), '+k')
plt.grid()
plt.savefig('../build_j/werte_log_2.pdf')
plt.clf()
...
plt.legend()
plt.savefig('../build_j/log(I)_1durchT_2.pdf')
plt.clf()
...
plt.legend()
plt.grid()
plt.savefig('../build_j/integral_1.pdf')
plt.clf()
...
plt.legend()
plt.grid()
plt.savefig('../build_j/integral_2.pdf')
plt.clf()
