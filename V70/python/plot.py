...
# np.savetxt('data/tab_turbo_saug.txt', np.column_stack([unp.nominal_values(smean)[0], unp.std_devs(smean)[0], unp.nominal_values(smean)[1], unp.std_devs(smean)[1], unp.nominal_values(smean)[2], unp.std_devs(smean)[2], unp.nominal_values(S_1), unp.std_devs(S_1), unp.nominal_values(S_2), unp.std_devs(S_2), unp.nominal_values(S_5), unp.std_devs(S_5), unp.nominal_values(S_7), unp.std_devs(S_7)]), fmt=['%.4f', '%.4f', '%.4f', '%.4f', '%.4f','%.4f', '%.4f', '%.4f', '%.4f', '%.4f', '%.4f', '%.4f', '%.4f', '%.4f'])   