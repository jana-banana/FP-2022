...
#Leckratenmessung
plt.errorbar(100, S[3], yerr=sig_S[3], xerr=50, fmt='+',color='blue', label='Leckrate 100 mbar' )
plt.errorbar( 50, S[2], yerr=sig_S[2], xerr=15, fmt='+',color='green', label='Leckrate 50 mbar' )
plt.errorbar( 10, S[1], yerr=sig_S[1], xerr=3, fmt='+',color='magenta', label='Leckrate 10 mbar' )
plt.errorbar(0.5, S[0], yerr=sig_S[0], xerr=0.15, fmt='+',color='brown', label='Leckrate 0.5 mbar' )
plt.rc('axes', labelsize=size_label)
...
#Evakuierungskurve
plt.errorbar(2520, unp.nominal_values(S_eva_t)[0], yerr=unp.std_devs(S_eva_t)[0], xerr=(5000+40)/2, fmt='+', color='red', label='Evakuierung 1' )
...
#Leckratenmessung
plt.errorbar(100, S[0], yerr=sig_S_t[0], xerr=30, fmt='+',color='blue', label='Leckrate 100 nbar' )
plt.errorbar(200, S[1], yerr=sig_S_t[1], xerr=60, fmt='+',color='green', label='Leckrate 200 nbar' )
plt.errorbar(50, S[2], yerr=sig_S_t[2], xerr=15, fmt='+',color='magenta', label='Leckrate 50 nbar' )
plt.errorbar(70, S[3], yerr=sig_S_t[3], xerr=21, fmt='+',color='brown', label='Leckrate 70 nbar' )
plt.rc('axes', labelsize=size_label)
